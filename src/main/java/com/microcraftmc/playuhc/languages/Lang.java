package com.microcraftmc.playuhc.languages;
...
public class Lang {
	...
	public static String SCOREBOARD_DISPLAYNAME;
	...
	public static String GAMETYPE_FFA_VANILLA;
	public static String GAMETYPE_FFA_CUTCLEAN;
	public static String GAMETYPE_TEAM_VANILLA;
	public static String GAMETYPE_TEAM_CUTCLEAN;
	...
	private void loadLangConfig() {
		...
		if(langFile.exists()){
			...
			// Scoreboard
			SCOREBOARD_DISPLAYNAME = ChatColor.translateAlternateColorCodes('&', lang.getString("scoreboard.displayname"));
			...
			// GameTypes
			GAMETYPE_FFA_VANILLA = ChatColor.translateAlternateColorCodes('&', lang.getString("gametype.ffa-vanilla"));
			GAMETYPE_FFA_CUTCLEAN = ChatColor.translateAlternateColorCodes('&', lang.getString("gametype.ffa-cutclean"));
			GAMETYPE_TEAM_VANILLA = ChatColor.translateAlternateColorCodes('&', lang.getString("gametype.team-vanilla"));
			GAMETYPE_TEAM_CUTCLEAN = ChatColor.translateAlternateColorCodes('&', lang.getString("gametype.team-cutclean"));
		}else{
			try {
	...
	private void saveDefaultEnglighLang() throws IOException {
		...
		lang.set("players.welcome-new", "Welcome to Microcraft UHC, please select your team");
		lang.set("players.welcome-ffa", "Welcome to Microcraft UHC, the game will be starting soon.");
		...
		// Display
		lang.set("display.message-prefix", "[UHC]");
		...
		// Scoreboard
		lang.set("scoreboard.displayname", "&6Microcraft UHC");
		...
		// GameTypes
		lang.set("gametype.ffa-vanilla","FFA Vanilla");
		lang.set("gametype.ffa-cutclean", "FFA CutClean");
		lang.set("gametype.team-vanilla", "To%teamsize% Vanilla");
		lang.set("gametype.team-cutclean", "To%teamsize% CutClean");
